...
namespace WorkoutApi.Data
{
    public static class DbInitializer
    {
        ...
        {
            if(context.Workouts.Any() || context.WorkoutPlans.Any() || context.WorkoutPlanItems.Any() || context.CheatMeals.Any() ||  context.UserWorkout.Any() || context.UserWorkoutEnrollments.Any() )
            {
                return;
            }
